...
.method public onApplyWindowInsets(Landroid/view/View;Landroid/support/v4/view/ac;)Landroid/support/v4/view/ac;
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/ac;->a()I
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/ac;->c()I

    move-result v2

    invoke-virtual {p2}, Landroid/support/v4/view/ac;->d()I
    ...
    invoke-virtual {p1, p2}, Landroid/support/design/internal/j;->onInsetsChanged(Landroid/support/v4/view/ac;)V

    iget-object p1, p0, Landroid/support/design/internal/j$1;->a:Landroid/support/design/internal/j;

    invoke-virtual {p2}, Landroid/support/v4/view/ac;->e()Z
    ...
    invoke-static {p1}, Landroid/support/v4/view/u;->d(Landroid/view/View;)V

    invoke-virtual {p2}, Landroid/support/v4/view/ac;->g()Landroid/support/v4/view/ac;
