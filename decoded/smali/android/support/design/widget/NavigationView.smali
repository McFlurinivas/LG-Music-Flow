...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p1}, Landroid/support/design/internal/f;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/design/widget/NavigationView;->mMenu:Landroid/support/design/internal/f;
    ...
    invoke-static {p0, p3}, Landroid/support/v4/view/u;->b(Landroid/view/View;Z)V
    ...
    invoke-virtual {v1, v8}, Landroid/support/design/internal/f;->setCallback(Landroid/support/v7/view/menu/MenuBuilder$Callback;)V

    invoke-virtual {v0, v4}, Landroid/support/design/internal/g;->a(I)V

    invoke-virtual {v0, p1, v1}, Landroid/support/design/internal/g;->initForMenu(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;)V

    invoke-virtual {v0, p3}, Landroid/support/design/internal/g;->a(Landroid/content/res/ColorStateList;)V

    if-eqz v5, :cond_5

    invoke-virtual {v0, v3}, Landroid/support/design/internal/g;->d(I)V

    :cond_5
    invoke-virtual {v0, v6}, Landroid/support/design/internal/g;->b(Landroid/content/res/ColorStateList;)V

    invoke-virtual {v0, v7}, Landroid/support/design/internal/g;->a(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v1, v0}, Landroid/support/design/internal/f;->addMenuPresenter(Landroid/support/v7/view/menu/MenuPresenter;)V

    invoke-virtual {v0, p0}, Landroid/support/design/internal/g;->getMenuView(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/MenuView;
...
.method public getHeaderCount()I
    ...
    invoke-virtual {v0}, Landroid/support/design/internal/g;->a()I
...
.method public getItemBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/design/internal/g;->d()Landroid/graphics/drawable/Drawable;
...
.method public getItemIconTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Landroid/support/design/internal/g;->b()Landroid/content/res/ColorStateList;
...
.method public getItemTextColor()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Landroid/support/design/internal/g;->c()Landroid/content/res/ColorStateList;
...
.method protected onInsetsChanged(Landroid/support/v4/view/ac;)V
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->mPresenter:Landroid/support/design/internal/g;

    invoke-virtual {v0, p1}, Landroid/support/design/internal/g;->a(Landroid/support/v4/view/ac;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/internal/f;->restorePresenterStates(Landroid/os/Bundle;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0, v2}, Landroid/support/design/internal/f;->savePresenterStates(Landroid/os/Bundle;)V
