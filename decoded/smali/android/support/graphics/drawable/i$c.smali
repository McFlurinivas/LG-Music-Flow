...
.method public constructor <init>(Landroid/support/graphics/drawable/i$c;Landroid/support/v4/i/a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v1, p0, Landroid/support/graphics/drawable/i$c;->m:Ljava/lang/String;

    iget v1, p1, Landroid/support/graphics/drawable/i$c;->b:F

    iput v1, p0, Landroid/support/graphics/drawable/i$c;->b:F

    iget v1, p1, Landroid/support/graphics/drawable/i$c;->e:F

    iput v1, p0, Landroid/support/graphics/drawable/i$c;->e:F

    iget v1, p1, Landroid/support/graphics/drawable/i$c;->f:F

    iput v1, p0, Landroid/support/graphics/drawable/i$c;->f:F

    iget v1, p1, Landroid/support/graphics/drawable/i$c;->g:F

    iput v1, p0, Landroid/support/graphics/drawable/i$c;->g:F

    iget v1, p1, Landroid/support/graphics/drawable/i$c;->h:F

    iput v1, p0, Landroid/support/graphics/drawable/i$c;->h:F

    iget v1, p1, Landroid/support/graphics/drawable/i$c;->i:F

    iput v1, p0, Landroid/support/graphics/drawable/i$c;->i:F

    iget v1, p1, Landroid/support/graphics/drawable/i$c;->j:F

    iput v1, p0, Landroid/support/graphics/drawable/i$c;->j:F

    iget-object v1, p1, Landroid/support/graphics/drawable/i$c;->l:[I

    iput-object v1, p0, Landroid/support/graphics/drawable/i$c;->l:[I

    iget-object v1, p1, Landroid/support/graphics/drawable/i$c;->m:Ljava/lang/String;

    iput-object v1, p0, Landroid/support/graphics/drawable/i$c;->m:Ljava/lang/String;

    iget v2, p1, Landroid/support/graphics/drawable/i$c;->c:I

    iput v2, p0, Landroid/support/graphics/drawable/i$c;->c:I

    if-eqz v1, :cond_0

    invoke-virtual {p2, v1, p0}, Landroid/support/v4/i/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p1, Landroid/support/graphics/drawable/i$c;->a:Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v1, p2}, Landroid/support/graphics/drawable/i$c;-><init>(Landroid/support/graphics/drawable/i$c;Landroid/support/v4/i/a;)V
    ...
    :cond_2
    instance-of v2, v1, Landroid/support/graphics/drawable/i$a;

    if-eqz v2, :cond_4

    new-instance v2, Landroid/support/graphics/drawable/i$a;

    check-cast v1, Landroid/support/graphics/drawable/i$a;

    invoke-direct {v2, v1}, Landroid/support/graphics/drawable/i$a;-><init>(Landroid/support/graphics/drawable/i$a;)V

    :goto_1
    iget-object v1, p0, Landroid/support/graphics/drawable/i$c;->a:Ljava/util/ArrayList;

    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v2, Landroid/support/graphics/drawable/i$d;->n:Ljava/lang/String;

    if-eqz v1, :cond_3

    iget-object v1, v2, Landroid/support/graphics/drawable/i$d;->n:Ljava/lang/String;

    invoke-virtual {p2, v1, v2}, Landroid/support/v4/i/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method static synthetic a(Landroid/support/graphics/drawable/i$c;)Landroid/graphics/Matrix;
    ...
    iget-object p0, p0, Landroid/support/graphics/drawable/i$c;->d:Landroid/graphics/Matrix;
...
.method private a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p1, p2, v1, v2, v0}, Landroid/support/v4/a/a/c;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    iput p2, p0, Landroid/support/graphics/drawable/i$c;->j:F
    ...
    iput-object p1, p0, Landroid/support/graphics/drawable/i$c;->m:Ljava/lang/String;
...
.method static synthetic b(Landroid/support/graphics/drawable/i$c;)Landroid/graphics/Matrix;
    ...
    iget-object p0, p0, Landroid/support/graphics/drawable/i$c;->k:Landroid/graphics/Matrix;
...
.method public a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-direct {p0, p1, p4}, Landroid/support/graphics/drawable/i$c;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
