...
.method public constructor <init>(Landroid/support/graphics/drawable/i$f;)V
    ...
    iget-boolean p1, p1, Landroid/support/graphics/drawable/i$f;->e:Z

    iput-boolean p1, p0, Landroid/support/graphics/drawable/i$f;->e:Z
...
.method public a(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/graphics/drawable/i$f;->l:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/i$f;->l:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, Landroid/support/graphics/drawable/i$f;->l:Landroid/graphics/Paint;
...
.method public b(II)V
    ...
    iput-object p1, p0, Landroid/support/graphics/drawable/i$f;->f:Landroid/graphics/Bitmap;

    const/4 p1, 0x1

    iput-boolean p1, p0, Landroid/support/graphics/drawable/i$f;->k:Z
...
.method public b()Z
    ...
    iget-object v0, p0, Landroid/support/graphics/drawable/i$f;->g:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/graphics/drawable/i$f;->c:Landroid/content/res/ColorStateList;

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Landroid/support/graphics/drawable/i$f;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v1, p0, Landroid/support/graphics/drawable/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Landroid/support/graphics/drawable/i$f;->j:Z

    iget-boolean v1, p0, Landroid/support/graphics/drawable/i$f;->e:Z

    if-ne v0, v1, :cond_0

    iget v0, p0, Landroid/support/graphics/drawable/i$f;->i:I
...
.method public c()V
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/i$f;->g:Landroid/content/res/ColorStateList;

    iget-object v0, p0, Landroid/support/graphics/drawable/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v0, p0, Landroid/support/graphics/drawable/i$f;->h:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v0, p0, Landroid/support/graphics/drawable/i$f;->i:I

    iget-boolean v0, p0, Landroid/support/graphics/drawable/i$f;->e:Z

    iput-boolean v0, p0, Landroid/support/graphics/drawable/i$f;->j:Z
...
.method public c(II)Z
    ...
    iget-object p1, p0, Landroid/support/graphics/drawable/i$f;->f:Landroid/graphics/Bitmap;
...
.method public newDrawable(Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p1, p0}, Landroid/support/graphics/drawable/i;-><init>(Landroid/support/graphics/drawable/i$f;)V
