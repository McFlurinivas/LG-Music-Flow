...
.method private static a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroid/support/v4/a/a/b$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v9, v14, v10}, Landroid/support/v4/a/a/b$a;->callbackFailAsync(ILandroid/os/Handler;)V

    :cond_0
    return-object v13

    :cond_1
    invoke-static {v0, v4, v5}, Landroid/support/v4/b/c;->a(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v9, v1, v10}, Landroid/support/v4/a/a/b$a;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-static {v1, v0}, Landroid/support/v4/a/a/a;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/a/a/a$a;
    ...
    invoke-static {p0, v0, v4, v12, v5}, Landroid/support/v4/b/c;->a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v9, v0, v10}, Landroid/support/v4/a/a/b$a;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
