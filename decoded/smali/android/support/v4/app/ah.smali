...
.method private static a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    sget v2, Landroid/support/v4/app/ah;->b:I
...
.method public a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;)Landroid/os/Parcelable;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ah;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    sget v3, Landroid/support/v4/app/ah;->b:I
    ...
    iget-object v3, p0, Landroid/support/v4/app/ah;->a:Landroid/graphics/Matrix;
    ...
    iput-object v3, p0, Landroid/support/v4/app/ah;->a:Landroid/graphics/Matrix;
    ...
    iget-object p2, p0, Landroid/support/v4/app/ah;->a:Landroid/graphics/Matrix;
    ...
    iget-object p3, p0, Landroid/support/v4/app/ah;->a:Landroid/graphics/Matrix;
...
.method public a(Ljava/util/List;Ljava/util/List;Landroid/support/v4/app/ah$a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3}, Landroid/support/v4/app/ah$a;->a()V
