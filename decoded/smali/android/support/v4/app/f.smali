...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/support/v4/app/f$1;-><init>()V
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/f;->a:[I
    ...
    iput v0, p0, Landroid/support/v4/app/f;->c:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/f;->d:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v4/app/f;->g:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v4/app/f;->i:Ljava/lang/CharSequence;

    invoke-virtual {p1}, Landroid/os/Parcel;->createStringArrayList()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/f;->j:Ljava/util/ArrayList;

    invoke-virtual {p1}, Landroid/os/Parcel;->createStringArrayList()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/f;->k:Ljava/util/ArrayList;
    ...
    :goto_0
    iput-boolean p1, p0, Landroid/support/v4/app/f;->l:Z
...
.method public constructor <init>(Landroid/support/v4/app/e;)V
    ...
    iput-object v1, p0, Landroid/support/v4/app/f;->a:[I
    ...
    iget-object v4, p0, Landroid/support/v4/app/f;->a:[I
    ...
    iget-object v2, p0, Landroid/support/v4/app/f;->a:[I

    add-int/lit8 v4, v5, 0x1

    iget-object v6, v3, Landroid/support/v4/app/e$a;->b:Landroid/support/v4/app/k;
...
# virtual methods
.method public a(Landroid/support/v4/app/q;)Landroid/support/v4/app/e;
    .locals 6

    new-instance v0, Landroid/support/v4/app/e;

    invoke-direct {v0, p1}, Landroid/support/v4/app/e;-><init>(Landroid/support/v4/app/q;)V
    ...
    :goto_0
    iget-object v3, p0, Landroid/support/v4/app/f;->a:[I
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/f;->a:[I
    ...
    iget-object v5, p1, Landroid/support/v4/app/q;->f:Landroid/util/SparseArray;
    ...
    :goto_1
    iput-object v1, v3, Landroid/support/v4/app/e$a;->b:Landroid/support/v4/app/k;
    ...
    iput v1, v3, Landroid/support/v4/app/e$a;->c:I
    ...
    iput v1, v3, Landroid/support/v4/app/e$a;->d:I
    ...
    iput v1, v3, Landroid/support/v4/app/e$a;->e:I
    ...
    :cond_2
    iget p1, p0, Landroid/support/v4/app/f;->b:I

    iput p1, v0, Landroid/support/v4/app/e;->g:I

    iget p1, p0, Landroid/support/v4/app/f;->c:I

    iput p1, v0, Landroid/support/v4/app/e;->h:I

    iget-object p1, p0, Landroid/support/v4/app/f;->d:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/support/v4/app/f;->g:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroid/support/v4/app/f;->i:Ljava/lang/CharSequence;

    iput-object v1, v0, Landroid/support/v4/app/e;->q:Ljava/lang/CharSequence;

    iget-object v1, p0, Landroid/support/v4/app/f;->j:Ljava/util/ArrayList;

    iput-object v1, v0, Landroid/support/v4/app/e;->r:Ljava/util/ArrayList;

    iget-object v1, p0, Landroid/support/v4/app/f;->k:Ljava/util/ArrayList;

    iput-object v1, v0, Landroid/support/v4/app/e;->s:Ljava/util/ArrayList;

    iget-boolean v1, p0, Landroid/support/v4/app/f;->l:Z
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object p2, p0, Landroid/support/v4/app/f;->a:[I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeIntArray([I)V

    iget p2, p0, Landroid/support/v4/app/f;->b:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget p2, p0, Landroid/support/v4/app/f;->c:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-object p2, p0, Landroid/support/v4/app/f;->d:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget p2, p0, Landroid/support/v4/app/f;->e:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget p2, p0, Landroid/support/v4/app/f;->f:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-object p2, p0, Landroid/support/v4/app/f;->g:Ljava/lang/CharSequence;

    const/4 v0, 0x0

    invoke-static {p2, p1, v0}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget p2, p0, Landroid/support/v4/app/f;->h:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-object p2, p0, Landroid/support/v4/app/f;->i:Ljava/lang/CharSequence;

    invoke-static {p2, p1, v0}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget-object p2, p0, Landroid/support/v4/app/f;->j:Ljava/util/ArrayList;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeStringList(Ljava/util/List;)V

    iget-object p2, p0, Landroid/support/v4/app/f;->k:Ljava/util/ArrayList;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeStringList(Ljava/util/List;)V

    iget-boolean p2, p0, Landroid/support/v4/app/f;->l:Z
