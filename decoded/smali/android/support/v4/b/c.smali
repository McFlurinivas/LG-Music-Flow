...
.field private static final b:Landroid/support/v4/i/g;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/b/c;->b:Landroid/support/v4/i/g;
...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    sget-object p2, Landroid/support/v4/b/c;->b:Landroid/support/v4/i/g;

    invoke-virtual {p2, p1, p0}, Landroid/support/v4/i/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/g/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Landroid/support/v4/b/c$a;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/g/b$b;I)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/a/a/a$a;Landroid/content/res/Resources;IILandroid/support/v4/a/a/b$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/a/a/a$d;->a()Landroid/support/v4/g/a;
    ...
    invoke-static/range {v0 .. v6}, Landroid/support/v4/g/b;->a(Landroid/content/Context;Landroid/support/v4/g/a;Landroid/support/v4/a/a/b$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    sget-object v1, Landroid/support/v4/b/c;->b:Landroid/support/v4/i/g;

    invoke-static {p2, p3, p4}, Landroid/support/v4/b/c;->b(Landroid/content/res/Resources;II)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2, v0}, Landroid/support/v4/i/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static a(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    sget-object v0, Landroid/support/v4/b/c;->b:Landroid/support/v4/i/g;

    invoke-static {p0, p1, p2}, Landroid/support/v4/b/c;->b(Landroid/content/res/Resources;II)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Landroid/support/v4/i/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
