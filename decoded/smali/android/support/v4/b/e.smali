...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/g/b$b;I)Landroid/graphics/Typeface;
    ...
    new-instance v1, Landroid/support/v4/i/m;

    invoke-direct {v1}, Landroid/support/v4/i/m;-><init>()V
    ...
    invoke-virtual {v4}, Landroid/support/v4/g/b$b;->a()Landroid/net/Uri;

    move-result-object v5

    invoke-virtual {v1, v5}, Landroid/support/v4/i/m;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v5, v6}, Landroid/support/v4/i/m;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    invoke-virtual {v4}, Landroid/support/v4/g/b$b;->b()I

    move-result v5

    invoke-virtual {v4}, Landroid/support/v4/g/b$b;->c()I

    move-result v7

    invoke-virtual {v4}, Landroid/support/v4/g/b$b;->d()Z
