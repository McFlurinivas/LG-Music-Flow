...
.method public run()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a$1;->a:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a$1;->b:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a$1;->b:Landroid/os/IBinder;

    iget-object v5, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a$1;->c:Landroid/support/v4/media/MediaBrowserCompat$i$a;

    iget-object v5, v5, Landroid/support/v4/media/MediaBrowserCompat$i$a;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v5, v5, Landroid/support/v4/media/MediaBrowserCompat$i;->d:Landroid/os/Bundle;

    invoke-direct {v3, v4, v5}, Landroid/support/v4/media/MediaBrowserCompat$l;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v3, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->h:Landroid/support/v4/media/MediaBrowserCompat$l;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a$1;->c:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iput-object v3, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->i:Landroid/os/Messenger;
    ...
    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$i;->i:Landroid/os/Messenger;
    ...
    iput v3, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->f:I
