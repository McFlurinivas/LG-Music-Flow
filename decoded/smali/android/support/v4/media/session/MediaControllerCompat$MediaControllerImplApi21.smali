...
.method private f()V
    ...
    iput-boolean v4, v2, Landroid/support/v4/media/session/MediaControllerCompat$a;->mHasExtraCallback:Z
    :try_end_0
    ...
    :try_start_2
    invoke-virtual {v2}, Landroid/support/v4/media/session/MediaControllerCompat$a;->onSessionReady()V
...
.method public final a(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {p1, v0}, Landroid/support/v4/media/session/b;->b(Landroid/support/v4/media/session/a;)V
    :try_end_0
...
.method public final a(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    iget-object p2, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->c:Landroid/support/v4/media/session/b;
    ...
    invoke-interface {p1, p2}, Landroid/support/v4/media/session/b;->a(Landroid/support/v4/media/session/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
