...
.method public a(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    :try_start_0
    iget-object p2, p0, Landroid/support/v4/media/session/MediaControllerCompat$e;->a:Landroid/support/v4/media/session/b;

    invoke-interface {p2}, Landroid/support/v4/media/session/b;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2, v0}, Landroid/support/v4/media/session/b;->a(Landroid/support/v4/media/session/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
