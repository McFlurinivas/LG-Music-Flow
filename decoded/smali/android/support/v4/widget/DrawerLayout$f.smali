...
.method public a(Landroid/support/v4/widget/r;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout$f;->c:Landroid/support/v4/widget/r;
...
.method b()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout$f;->c:Landroid/support/v4/widget/r;
    ...
    :cond_2
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout$f;->a:Landroid/support/v4/widget/DrawerLayout;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout$f;->c:Landroid/support/v4/widget/r;

    invoke-virtual {v4}, Landroid/view/View;->getTop()I

    move-result v5

    invoke-virtual {v1, v4, v3, v5}, Landroid/support/v4/widget/r;->a(Landroid/view/View;II)Z
...
.method public onEdgeDragStarted(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/widget/r;->a(Landroid/view/View;I)V
...
.method public onViewDragStateChanged(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout$f;->c:Landroid/support/v4/widget/r;
...
.method public onViewReleased(Landroid/view/View;FF)V
    ...
    :goto_1
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout$f;->c:Landroid/support/v4/widget/r;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result p1

    invoke-virtual {p3, p2, p1}, Landroid/support/v4/widget/r;->a(II)Z
