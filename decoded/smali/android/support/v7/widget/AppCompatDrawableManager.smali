...
.field private mKnownDrawableIdTags:Landroid/support/v4/i/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    check-cast v1, Landroid/support/v4/i/f;

    if-nez v1, :cond_0

    new-instance v1, Landroid/support/v4/i/f;

    invoke-direct {v1}, Landroid/support/v4/i/f;-><init>()V
    ...
    invoke-virtual {v1, p2, p3, p1}, Landroid/support/v4/i/f;->b(JLjava/lang/Object;)V
...
.method private addTintListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/i/n;->c(ILjava/lang/Object;)V
...
.method private getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    invoke-virtual {v1, p2, p3}, Landroid/support/v4/i/f;->a(J)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {v1, p2, p3}, Landroid/support/v4/i/f;->b(J)V
...
.method private getTintListFromCache(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    check-cast p1, Landroid/support/v4/i/n;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Landroid/support/v4/i/n;->a(I)Ljava/lang/Object;
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/support/v4/i/n;

    const-string v2, "appcompat_skip_skip"

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2}, Landroid/support/v4/i/n;->a(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Landroid/support/v4/i/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/support/v4/i/n;
    ...
    iget-object v8, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/support/v4/i/n;

    invoke-virtual {v8, p2, v3}, Landroid/support/v4/i/n;->c(ILjava/lang/Object;)V

    iget-object v8, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Landroid/support/v4/i/a;

    invoke-virtual {v8, v3}, Landroid/support/v4/i/a;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/support/v4/i/n;

    invoke-virtual {p1, p2, v2}, Landroid/support/v4/i/n;->c(ILjava/lang/Object;)V
...
.method private removeDelegate(Ljava/lang/String;Landroid/support/v7/widget/AppCompatDrawableManager$InflateDelegate;)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Landroid/support/v4/i/a;

    invoke-virtual {p2, p1}, Landroid/support/v4/i/a;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public onConfigurationChanged(Landroid/content/Context;)V
    ...
    check-cast p1, Landroid/support/v4/i/f;
