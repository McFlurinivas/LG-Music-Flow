...
.method public static a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/internal/ba;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method static a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bb;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/ba;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/ba;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/ba;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/g;->show(Landroid/support/v4/app/p;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/ba;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p3

    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/ba;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    new-instance v2, Landroid/support/v4/app/ac$c;

    invoke-direct {v2, p1}, Landroid/support/v4/app/ac$c;-><init>(Landroid/content/Context;)V

    const v5, 0x108008a

    invoke-virtual {v2, v5}, Landroid/support/v4/app/ac$c;->a(I)Landroid/support/v4/app/ac$c;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/app/ac$c;->d(Ljava/lang/CharSequence;)Landroid/support/v4/app/ac$c;
    ...
    invoke-virtual {v1, v5, v6}, Landroid/support/v4/app/ac$c;->a(J)Landroid/support/v4/app/ac$c;

    move-result-object v1

    invoke-virtual {v1, v4}, Landroid/support/v4/app/ac$c;->c(Z)Landroid/support/v4/app/ac$c;

    move-result-object v1

    invoke-virtual {v1, p4}, Landroid/support/v4/app/ac$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/ac$c;

    move-result-object p4

    invoke-virtual {p4, p3}, Landroid/support/v4/app/ac$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ac$c;

    move-result-object p3

    invoke-virtual {p3, v0}, Landroid/support/v4/app/ac$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/ac$c;

    move-result-object p3

    invoke-virtual {p3, v4}, Landroid/support/v4/app/ac$c;->d(Z)Landroid/support/v4/app/ac$c;

    move-result-object p3

    new-instance p4, Landroid/support/v4/app/ac$b;

    invoke-direct {p4}, Landroid/support/v4/app/ac$b;-><init>()V

    invoke-virtual {p4, v0}, Landroid/support/v4/app/ac$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ac$b;

    move-result-object p4

    invoke-virtual {p3, p4}, Landroid/support/v4/app/ac$c;->a(Landroid/support/v4/app/ac$d;)Landroid/support/v4/app/ac$c;

    move-result-object p3

    invoke-virtual {p3}, Landroid/support/v4/app/ac$c;->a()Landroid/app/Notification;
    ...
    sget-object p4, Lcom/google/android/gms/common/w;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0, p3}, Lcom/google/android/gms/common/internal/bb;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/bb;

    move-result-object p3

    invoke-static {p1, p2, p3, p4}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bb;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/a;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/gms/common/m;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public final a(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/bb;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-static {p1, p3, p4}, Lcom/google/android/gms/common/m;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object p4

    const/4 v0, 0x2

    invoke-static {p2, p4, v0}, Lcom/google/android/gms/common/internal/bb;->a(Lcom/google/android/gms/common/api/internal/bb;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/bb;

    move-result-object p2

    invoke-static {p1, p3, p2, p5}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bb;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
