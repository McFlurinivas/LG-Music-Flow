.class public Lcom/lge/media/musicflow/genres/members/b;
...
.method public synthetic a(Landroid/view/ViewGroup;)Lcom/lge/media/musicflow/p$e;
    ...
    invoke-virtual {p0, p1}, Lcom/lge/media/musicflow/genres/members/b;->b(Landroid/view/ViewGroup;)Lcom/lge/media/musicflow/p$b;
...
.method public a(Lcom/lge/media/musicflow/p$b;Landroid/database/Cursor;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/lge/media/musicflow/genres/members/b;->a(Lcom/lge/media/musicflow/p$b;I)V
    ...
    iget-object v4, p0, Lcom/lge/media/musicflow/genres/members/b;->d:Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/lge/media/musicflow/genres/members/b;->e()Landroid/content/Context;

    move-result-object v1

    iget-object v2, p1, Lcom/lge/media/musicflow/p$b;->d:Landroid/widget/ImageView;

    sget-object v3, Lcom/lge/media/musicflow/genres/members/b;->g:Ljava/lang/String;

    invoke-virtual {p0, v1, v2, p2, v3}, Lcom/lge/media/musicflow/genres/members/b;->a(Landroid/content/Context;Landroid/widget/ImageView;Landroid/net/Uri;Ljava/lang/String;)V

    const/4 p2, 0x1

    const/4 v1, 0x0

    invoke-virtual {p0, p1, v0, p2, v1}, Lcom/lge/media/musicflow/genres/members/b;->a(Lcom/lge/media/musicflow/p$b;IZZ)V
...
.method public bridge synthetic a(Lcom/lge/media/musicflow/p$e;Landroid/database/Cursor;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/lge/media/musicflow/genres/members/b;->a(Lcom/lge/media/musicflow/p$b;Landroid/database/Cursor;)V
...
.method public b(Landroid/view/ViewGroup;)Lcom/lge/media/musicflow/p$b;
    ...
    iget-object v0, p0, Lcom/lge/media/musicflow/genres/members/b;->e:Landroid/view/LayoutInflater;

    iget-object v1, p0, Lcom/lge/media/musicflow/genres/members/b;->f:Lcom/lge/media/musicflow/p$e$a;
