.class public Lcom/lge/media/musicflow/playlists/d;
...
.method public synthetic a(Landroid/view/ViewGroup;)Lcom/lge/media/musicflow/p$e;
    ...
    invoke-virtual {p0, p1}, Lcom/lge/media/musicflow/playlists/d;->b(Landroid/view/ViewGroup;)Lcom/lge/media/musicflow/p$b;
...
.method public a(Lcom/lge/media/musicflow/p$b;Landroid/database/Cursor;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/lge/media/musicflow/playlists/d;->a(Lcom/lge/media/musicflow/p$b;I)V
    ...
    iget-object v4, p0, Lcom/lge/media/musicflow/playlists/d;->d:Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/lge/media/musicflow/playlists/d;->e()Landroid/content/Context;

    move-result-object v1

    iget-object v2, p1, Lcom/lge/media/musicflow/p$b;->d:Landroid/widget/ImageView;

    sget-object v3, Lcom/lge/media/musicflow/playlists/d;->g:Ljava/lang/String;

    invoke-virtual {p0, v1, v2, p2, v3}, Lcom/lge/media/musicflow/playlists/d;->a(Landroid/content/Context;Landroid/widget/ImageView;Landroid/net/Uri;Ljava/lang/String;)V

    const/4 p2, 0x1

    invoke-virtual {p0}, Lcom/lge/media/musicflow/playlists/d;->f()Z

    move-result v1

    invoke-virtual {p0, p1, v0, p2, v1}, Lcom/lge/media/musicflow/playlists/d;->a(Lcom/lge/media/musicflow/p$b;IZZ)V
...
.method public bridge synthetic a(Lcom/lge/media/musicflow/p$e;Landroid/database/Cursor;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/lge/media/musicflow/playlists/d;->a(Lcom/lge/media/musicflow/p$b;Landroid/database/Cursor;)V
...
.method public b(Landroid/view/ViewGroup;)Lcom/lge/media/musicflow/p$b;
    ...
    iget-object v0, p0, Lcom/lge/media/musicflow/playlists/d;->e:Landroid/view/LayoutInflater;

    iget-object v1, p0, Lcom/lge/media/musicflow/playlists/d;->f:Lcom/lge/media/musicflow/p$e$a;
