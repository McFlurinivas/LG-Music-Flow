...
# direct methods
.method public constructor <init>(Lorg/fourthline/cling/transport/impl/jetty/StreamClientConfigurationImpl;Lorg/b/a/a/g;Lorg/fourthline/cling/model/message/StreamRequestMessage;)V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lorg/b/a/a/f;-><init>(Z)V
    ...
    iput-object p2, p0, Lorg/fourthline/cling/transport/impl/jetty/StreamClientImpl$HttpContentExchange;->client:Lorg/b/a/a/g;
...
.method protected applyRequestBody()V
    ...
    invoke-direct {v0, v3, v1}, Lorg/b/a/d/k;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {v0, v1}, Lorg/b/a/d/k;-><init>([B)V

    :goto_2
    invoke-virtual {v0}, Lorg/b/a/d/k;->l()I
    ...
    invoke-virtual {p0, v0}, Lorg/fourthline/cling/transport/impl/jetty/StreamClientImpl$HttpContentExchange;->setRequestContent(Lorg/b/a/d/e;)V
...
.method protected createResponse()Lorg/fourthline/cling/model/message/StreamResponseMessage;
    ...
    invoke-virtual {p0}, Lorg/fourthline/cling/transport/impl/jetty/StreamClientImpl$HttpContentExchange;->getResponseFields()Lorg/b/a/c/i;

    move-result-object v2

    invoke-virtual {v2}, Lorg/b/a/c/i;->a()Ljava/util/Collection;
    ...
    invoke-virtual {v2, v4}, Lorg/b/a/c/i;->c(Ljava/lang/String;)Ljava/util/Collection;
